...
export const AuthPages = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden selection:bg-purple-600 selection:text-white">
      {/* Background Decorative Lavender Glow */}
      ...
      <div className="w-full max-w-lg relative z-10 space-y-6 animate-fadeIn">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-purple-600 via-purple-500 to-indigo-500 flex items-center justify-center shadow-xl shadow-purple-500/30">
              <BookOpen className="w-6 h-6 text-white" />
            </div>
            <div className="text-left">
              <span className="font-extrabold text-2xl tracking-tight bg-gradient-to-r from-white via-slate-100 to-purple-200 bg-clip-text text-transparent">
        ...
        <div className="p-6 sm:p-8 rounded-3xl glass-panel border-purple-500/30 space-y-6 shadow-2xl">
          ...
          {authMode === "signin" && (
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-2 p-1.5 rounded-2xl bg-zinc-950 border border-zinc-800">
                <button
                  type="button"
              ...
              <form onSubmit={handleSignIn} className="space-y-4 text-xs">
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs shadow-lg shadow-purple-600/30 transition-all flex items-center justify-center gap-2"
                >
              ...
              <div className="text-center pt-3 border-t border-zinc-800 text-xs text-slate-400">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full py-2.5 px-3 rounded-2xl bg-zinc-950 border border-zinc-800 text-white text-xs focus:outline-none focus:border-purple-500"
                    >
